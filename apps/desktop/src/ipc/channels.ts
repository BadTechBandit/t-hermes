...
export const PREPARE_SSH_TARGET_CHANNEL = "desktop:prepare-ssh-target";
...
export const SSH_HOST_KEY_PROMPT_CHANNEL = "desktop:ssh-host-key-prompt";
export const RESOLVE_SSH_HOST_KEY_PROMPT_CHANNEL = "desktop:resolve-ssh-host-key-prompt";

...
import nousResearchIconUrl from "../assets/nousresearch.svg";
...
export const HermesNousIcon: Icon = (props) => (
  <svg {...props} viewBox="0 0 24 24" fill="none">
    <rect
      ...
      fill="currentColor"
      style={{
        WebkitMask: `url(${nousResearchIconUrl}) center / contain no-repeat`,
        mask: `url(${nousResearchIconUrl}) center / contain no-repeat`,
      }}
    />
  </svg>
);

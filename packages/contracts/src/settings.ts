...
export const HermesSettings = makeProviderSettingsSchema(
  {
    ...
    binaryPath: makeBinaryPathSetting("hermes").pipe(
      Schema.annotateKey({
        title: "Binary path",
        description: "Path to the Hermes binary used by this instance.",
    ...
    authMethodId: TrimmedString.pipe(
      Schema.withDecodingDefault(Effect.succeed("")),
      Schema.annotateKey({
        title: "ACP auth method",
        description: "Optional ACP auth method id. Leave blank to use Hermes' default.",
        providerSettingsForm: {
  ...
  {
    order: ["binaryPath", "homePath", "authMethodId"],
  },
);
...
export const OpenCodeSettings = makeProviderSettingsSchema(
  {
    ...
    serverUrl: TrimmedString.pipe(
      ...
      Schema.annotateKey({
        title: "Server URL",
        description: "Leave blank to let T-Hermes spawn the server when needed.",
        providerSettingsForm: {

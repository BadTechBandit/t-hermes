  ...
  embeds: [
    {
      ...
      description:
        options.target === "prerelease"
          ? "A new T-Hermes prerelease is available for nightly testers."
          : "A new T-Hermes latest release is available.",
...
).pipe(Command.withDescription("Post a T-Hermes release announcement to Discord."));
